var CONFIG = {
				COURSETITLE			: "Fast Track To Adobe Captivate 6",
				FILENAME			: "ExerciseFinal.swf",
				BGCOLOR				: "#5eb6c6",
				FPVERSION			: "10",
				COURSE_WIDTH		: "801",
				COURSE_HEIGHT		: "641",
...
function Captivate_DoExternalInterface() {
    ...
    if (CmdToExecute == "RecordMultipleChoiceInteraction") {
        ...
        var bStudent_response = (studentResponse_str.search(/TRUE/i) == 0 || 
									studentResponse_str == "T" || 
									studentResponse_str == "t") ? true : false;
        
		var bCorrect_response = (correctResponse_str.search(/TRUE/i) == 0 || 
									correctResponse_str == "T" || 
									correctResponse_str == "t") ? true : false;
